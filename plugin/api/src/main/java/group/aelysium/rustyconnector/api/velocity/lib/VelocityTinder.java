package group.aelysium.rustyconnector.api.velocity.lib;
...
public interface VelocityTinder {
     ...
     * @return {@link VelocityCoreServiceHandler}
     ...
     */
    VelocityCoreServiceHandler services() throws IllegalAccessError;
