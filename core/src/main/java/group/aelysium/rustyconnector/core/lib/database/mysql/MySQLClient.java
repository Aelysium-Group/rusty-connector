...
public class MySQLClient extends io.lettuce.core.RedisClient {
    private final char[] privateKey;
    private final String dataChannel;

    protected MySQLClient(ClientResources clientResources, RedisURI redisURI, @NotNull String dataChannel, char @NotNull [] privateKey) {
    ...
    public static MySQLClient create(ClientResources resources, RedisURI uri, @NotNull String dataChannel, char @NotNull [] privateKey) {
        return new MySQLClient(resources, uri, dataChannel, privateKey);
    }
    ...
    public static class Builder {
        ...
        public MySQLClient build() {
            ...
            MySQLClient client = MySQLClient.create(resources, uri, dataChannel, privateKey);
